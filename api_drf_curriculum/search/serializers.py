...
'''
Serializer que usará los creados anteriormente para mostrar todos los datos. 
Para usar los otros serializers, los creamos dentro del serializer principal y 
añadimos many=True, ya que queremos traer todos los datos de ese usuario.
'''
